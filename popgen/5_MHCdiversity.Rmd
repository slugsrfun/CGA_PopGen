...
for(haplo in pophapcnts$hapID) {
  ...
  pophapcnts$NGA[haplo] <- 
    sum(c(hap.out$allele1[which(hap.out$pop=="NGA")],
          hap.out$allele2[which(hap.out$pop=="NGA")]) == 
          pophapcnts$DQBex2Hap[haplo])
  
  #SGA frequencies
  pophapcnts$SGA[haplo] <- 
    sum(c(hap.out$allele1[which(hap.out$pop=="SGA")],
          hap.out$allele2[which(hap.out$pop=="SGA")]) == 
          pophapcnts$DQBex2Hap[haplo]) 
  
  #CGA12 frequencies (CGA-H)
  pophapcnts$CGA12[haplo] <- 
    sum(c(hap.out$allele1[which(hap.out$pop=="CGA-H" | hap.out$survivor == TRUE)],
          hap.out$allele2[which(hap.out$pop=="CGA-H" | hap.out$survivor == TRUE)]) == 
          pophapcnts$DQBex2Hap[haplo]) 
  
  #CGA23 frequencies (CGA)
  pophapcnts$CGA23[haplo] <- 
    sum(c(hap.out$allele1[which(hap.out$pop=="CGA" | hap.out$survivor == TRUE)],
          hap.out$allele2[which(hap.out$pop=="CGA" | hap.out$survivor == TRUE)]) == 
          pophapcnts$DQBex2Hap[haplo]) 
...
for(i in 1:nrow(DQBprops)) {
  DQBprops$NGA[i] <- sum(DQBmat[which(hap.out$pop=="NGA"),
                                i]>0)/sum(hap.out$pop=="NGA")
  DQBprops$CGA[i] <- sum(DQBmat[which(hap.out$pop=="CGA" | 
                                        hap.out$survivor == TRUE),
                                i]>0)/sum(hap.out$pop=="CGA")
  DQBprops$CGAH[i] <- sum(DQBmat[which(hap.out$pop=="CGA-H" | 
                                         hap.out$survivor == TRUE),
                                 i]>0)/sum(hap.out$pop=="CGA-H")
  DQBprops$SGA[i] <- sum(DQBmat[which(hap.out$pop=="SGA"),
                                i]>0)/sum(hap.out$pop=="SGA")
}
...
CGAmat <- DQBmat[which(hap.out$pop == "CGA" | hap.out$survivor == TRUE),]
SGAmat <- DQBmat[which(hap.out$pop == "SGA"),]
CGAHmat <- DQBmat[which(hap.out$pop == "CGA-H" | hap.out$survivor == TRUE),]
